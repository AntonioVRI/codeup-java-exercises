...
//        }
        ...
        // arraysLec.Dog Example
        Dog d1 = new Dog("Bean", 1);
        Dog d2 = new Dog("Patch", 3);
        Dog d3 = new Dog("Rolo", 5);
//
//
//        //Declaring a arraysLec.Dog array variable called dogs and creating a new arraysLec.Dog array with a length of 4
        Dog[] dogs = new Dog[4];
        dogs[0] = d1;
        dogs[1] = d2;
        dogs[2] = d3;
        ...
        * [LarraysLecture.arraysLec.Dog;@___________
        *
        * [ = single dimension
        * L = array contains a class or interface
        * arrays.arraysLec.Dog = type of object (arrays b/c in arrays package)
        */
...
//        String[] animals = {"arraysLec.Dog", "Rabbit", "Cat", "Snake", "Fish"};
